...
| `nocase`            | Compare field names case insensitively.                  | If specified, [automatcher](#automatch) compares each field names case insensitively.                                                                                              | `nocase`                                                                     |
| `preprocess func`   | call the preprocess function.                            | Call the specified function before the field copy lines. <br /> The function must have the same signiture with the copying function.                                               | `preprocess _preprocessFunc`                                                 |
| `postprocess func`  | call the postprocess function.                           | Call the specified function after the field copy lines. <br /> The function must have the same signiture with the copying function.                                                | `postprocess _postprocessFunc`                                               |
